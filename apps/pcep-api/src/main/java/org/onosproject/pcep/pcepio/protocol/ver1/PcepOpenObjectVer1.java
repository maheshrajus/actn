...
import org.onosproject.pcep.pcepio.types.GmplsCapabilityTlv;
import org.onosproject.pcep.pcepio.types.NodeAttributesTlv;
import org.onosproject.pcep.pcepio.types.PceccCapabilityTlv;
import org.onosproject.pcep.pcepio.types.PcepLabelDbVerTlv;
...
import org.onosproject.pcep.pcepio.types.StatefulLspDbVerTlv;
import org.onosproject.pcep.pcepio.types.StatefulPceCapabilityTlv;
import org.onosproject.pcep.pcepio.types.LsCapabilityTlv;
    ...
    protected static LinkedList<PcepValueType> parseOptionalTlv(ChannelBuffer cb) throws PcepParseException {
        ...
        while (4 <= cb.readableBytes()) {
            ...
            case SrPceCapabilityTlv.TYPE:
                ...
                break;
            case DomainIdTlv.TYPE:
                log.info("DomainIdTlv");
                if (DomainIdTlv.length > hLength) {
                    throw new PcepParseException("Invalid length received for SrPceCapabilityTlv.");
                }
                tlv = DomainIdTlv.read(cb);
                break;
            default:
