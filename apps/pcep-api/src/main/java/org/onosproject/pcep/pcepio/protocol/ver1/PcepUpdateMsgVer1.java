...
class PcepUpdateMsgVer1 implements PcepUpdateMsg {
    ...
    static class Reader implements PcepMessageReader<PcepUpdateMsg> {
        ...
        public boolean parseUpdateRequestList(ChannelBuffer cb) throws PcepParseException {
            ...
            log.info("PCUpd message decode begin");
            ...
            while (0 < cb.readableBytes()) {
                ...
                while ((yObjClass == PcepAssociationObjectVer1.ASSOCIATION_OBJ_CLASS)
                    ...
                    log.info("Parsing Association Object,Type: " + associationObj.getAssociationType()
                                     ...
                                     + ", Source: " + associationObj.getAssociationSource()
                                     + ", VnTlv: " + new String(vnTlv.getValue()));
                }
                pceUpdateReq.setAssociationObjectList(llAssociationList);
                if (resetIndex) {
                    cb.resetReaderIndex();
                }
                ...
                log.info("Parsing Ero");

                llUpdateRequestList.add(pceUpdateReq);
            }

            log.info("PCUpd message decoding finished");
    ...
    static class Writer implements PcepMessageWriter<PcepUpdateMsgVer1> {
        ...
        public void write(ChannelBuffer cb, PcepUpdateMsgVer1 message) throws PcepParseException {
            ...
            while (listIterator.hasNext()) {
                ...
                LinkedList<PcepAssociationObject> llAssociationObj = updateReq.getAssociationObjectList();
