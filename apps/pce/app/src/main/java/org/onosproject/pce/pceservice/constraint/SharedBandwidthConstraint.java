...
public final class SharedBandwidthConstraint extends BooleanConstraint {
     ...
     * @param pceService instance of pceService
     * @return true if link satisfies shared bandwidth constraint otherwise false
     */
    public boolean isValidLink(Link link, PceService pceService) {
        if (pceService == null) {
            return false;
        }
        ...
        return pceService.pceBandwidthAvailable(link, changedBwValue.bps());
