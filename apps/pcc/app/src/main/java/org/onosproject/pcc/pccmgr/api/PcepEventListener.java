...
public interface PcepEventListener {
     ...
     *
     * @param pceId id of the pce
     * @param msg the message
     */
    void handleMessage(PceId pceId, PcepMessage msg);
     ...
     */
    void handleEndOfSyncAction(PceId pceId, PcepMessage msg, PcepLspSyncAction endOfSyncAction);
}
