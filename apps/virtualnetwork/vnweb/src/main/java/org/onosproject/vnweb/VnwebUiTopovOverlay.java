...
import org.onosproject.net.resource.*;
 ...
 */
public class VnwebUiTopovOverlay extends UiTopoOverlay {

    // NOTE: this must match the ID defined in sampleTopov.js
    private static final String OVERLAY_ID = "vn-web-overlay";
